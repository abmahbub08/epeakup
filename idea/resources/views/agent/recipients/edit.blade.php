                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-9">
                                    <h2>Edit {{ $recipient->first_name.' '.$recipient->last_name }}'s Information</h2>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="first_name" id="first_name" type="text"
                                                   ...
                                                   value="{{old('first_name')? old('first_name'):$recipient->first_name}}" placeholder="First Name" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="last_name" id="last_name" type="text"
                                                   ...
                                                   value="{{old('last_name')? old('last_name'):$recipient->last_name}}" placeholder="Last Name" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="account_number" id="account_number"
                                                       value="{{ old('account_number')? old('account_number'):$recipient->account_number }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="account_number_confirmation"
                                                       ...
                                                       value="{{ old('account_number_confirmation')? old('account_number_confirmation'):$recipient->account_number }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="phone" id="phone" type="text"
                                                   ...
                                                   value="{{old('phone')? old('phone'):$recipient->phone}}" placeholder="Ex: 01xxxxxxxxx" required>
                                            @if ($errors->has('phone'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="email" id="email" type="email"
                                                   ...
                                                   value="{{old('email')? old('email'):$recipient->email}}" placeholder="Email" required>
                                            @if ($errors->has('email'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="address" id="address" type="text"
                                                   ...
                                                   value="{{old('address')? old('address'):$recipient->address_one}}" placeholder="Address" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="city" id="city" type="text"
                                                   ...
                                                   value="{{old('city')? old('city'):$recipient->city}}" placeholder="City" required>
                                            @if ($errors->has('city'))
                                                <span class="invalid-feedback" role="alert">
