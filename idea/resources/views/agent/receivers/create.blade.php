...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Add Receiver</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="client_name" id="client_name"
                                                    class="form-control{{ $errors->has('client_name')?' is-invalid':'' }}" required>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group form-check">
                                            <input name="policy" type="checkbox" class="form-check-input {{ $errors->has('policy')?" is-invalid":" " }}" id="policy" checked required>
                                            <label class="form-check-label" for="policy">I read <a href="#">Policy</a></label>
                                        ...
                                        <div class="form-group form-check">
                                            <input name="agreement" type="checkbox" class="form-check-input {{ $errors->has('agreement')?" is-invalid":" " }}" id="agreement" checked required>
