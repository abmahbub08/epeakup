...
<section id="intro" class="clearfix">
 ...
 <div class="container mt-5">
   ...
   <div class="col-md-12">
   <h2 class="text-center"><b>Privecy Policy of e-peakup</b></h2>
...
The website reserves the right to refuse or cancel any order placed for a product that is listed at an incorrect price on the website. This shall be regardless of whether the order has been confirmed and whether payment has been already collected from you. We will either refund the money or adjust payment ( limited payment option in this case) upon your request.<br><br>

We reserves the right to refuse delivery for credit card payments even if the credit card company has authorized the transaction. It is mandatory to give home or office landphone numbers for all such orders. We may confirm your order by phone, SMS or email before processing your order.<br><br>

If there is a mistake made by customer, or customer give us wrong mobile or account number and we can not recharge, deposit or if the recepient does not want to accept order (or account is locked), then we will not refund the order. We will charge our full admin fees 200 taka if you want to recharge your order to other mobile or deposit to other account.<br><br>

You are required to pay for any order placed by you on our website (bKash) as long as goods are as specified on our website and are delivered to you in good condition.<br><br>

You are required to provide a copy of your photo ID (passport or driver licence) if we need it.<br><br>
...
We do not hold any reponsibility for any changes in PayPal's, credit card's and bank's policy.<br><br>

The website design, text, graphics and all the website software are Copyright © 2013 e-peakup.<br><br>
